...
\begin{document}
  ...
  \begin{frame}{¿Qué es?}
    \begin{block}{¿Qué es?}
      \begin{itemize}
        ...
        \item Facil y rápido de integrar.
      \end{itemize}
    \end{block}
  \end{frame}
  ...
  \begin{frame}{¿Cómo surge?}
    \begin{block}{¿Cómo surge?}
      \begin{itemize}
        \item Necesitabamos datos de ejemplo para trabajar en proyectos.
  ...
  \begin{frame}[containsverbatim]{Installacion}
    \begin{block}{shell}
       \begin{verbatim}
...
SAMPLEDATAHELPER_MODELS = [
  ...
  \begin{frame}[containsverbatim]{Desde codigo}
