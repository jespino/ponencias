...
\begin{document}
  ...
  \begin{frame}{¿Que significa funcional?}
    \begin{itemize}
      \item Programación con funciones (matematicas)
  ...
  \begin{frame}{¿Que me da python?}
    \begin{itemize}
      \item Evaluación peresoza (Limitada).
...
print(prod(sum(sum(1,2),3), 4))
  ...
  \begin{frame}[containsverbatim]{Funcional vs. Imperativo}
    \begin{block}{Funcional con composición y aplicacion parcial}
       \begin{verbatim}
...
print(prod4(sum3(sum2(1))))
  ...
  \begin{frame}{Evaluación peresoza}
    \begin{itemize}
      \item Iteradores
      \item Generadores
    \end{itemize}
  ...
  \begin{frame}[containsverbatim]{Evaluación peresoza}
...
[11]
  ...
  \begin{frame}[containsverbatim]{Aplicación parcial}
    \begin{block}{Applicación parcial}
       \begin{verbatim}
...
def fact(n, acc=1):
  ...
  \begin{frame}[containsverbatim]{Applicación parcial}
    \begin{block}{Applicación parcial}
      \begin{verbatim}
>>> from fn import F
...
[3, 4, 5]
  ...
  \begin{frame}{Consclusiones}
    \begin{itemize}
      ...
      \item Lo que se puede aplicar en Python es una mejora significativa sobre el codigo.
    \end{itemize}
  \end{frame}
